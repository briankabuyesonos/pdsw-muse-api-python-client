...
For more information regarding muse, please see: https://github.com/Sonos-Inc/pdsw-muse-api-python-client
...
Mustache templates are divided into two parts:
    ...
    * The Mustache template (mustache/*.mustache) - This is where all client output code and
       formatting should go.
    * The view class (mustache/muse_client_view.py) - This reads the xmls and formats the information
...
https://github.com/Sonos-Inc/pdsw-muse-api-python-client/releases

To generate and install the package locally (Linux instructions):

    1. Checkout the "pdsw-muse-api-python-client" repo (Mainline is fine unless you need a specific branch): 
       https://github.com/Sonos-Inc/pdsw-muse-api-python-client
    2. cd into the "pdsw-muse-api-python-client" dir
